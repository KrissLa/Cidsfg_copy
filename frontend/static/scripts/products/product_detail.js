...
const navItems = document.querySelectorAll('.tabs-controls-item.info'),
    ...
    accordionItems = document.querySelectorAll('.contentBx'),
    ...
    scrollToActiveTab = (e, arr, container) => {
        let getWidth = 0;
...
prohibitLetterEntry(form.querySelector('#input-credit'));
...
const consultationRequestModal = new HystModal({
    ...
    beforeOpen: function (modal) {
        console.log(modal);
        console.log(modal.openedWindow);
        if (modal.openedWindow == document.querySelector('#imageModal')){
            let src = modal.starter.getAttribute('src');
        let dataSrc;
        ...
        document.querySelector('#imageModal .hystmodal__window').insertAdjacentHTML('afterbegin', `<img class="lazy" src="${src}" data-src="${dataSrc}"/>`);
        document.querySelector('#imageModal .hystmodal__window img').style.width = '100%';
        document.querySelector('#imageModal .hystmodal__window').style.width = 'unset';
        document.querySelector('#imageModal .hystmodal__window').style.maxWidth = '90%';
        let newLazyLoadInstance = new LazyLoad({});
    ...
    afterClose: function (modal) {
        if (modal.openedWindow == document.querySelector('#imageModal')) {
            document.querySelector('#imageModal .hystmodal__window img').remove();
        }
