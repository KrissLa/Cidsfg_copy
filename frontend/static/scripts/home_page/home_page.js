...
const timeline = document.querySelector('#timeline-1'),
    ...
    tabs = document.querySelectorAll('.tabs-controls-wrapper'),
    addScrollbar = () => {
        tabs.forEach(e => {
    ...
    lines = document.querySelectorAll('.lines .line'),
    ...
    line = document.querySelector('#line-1'),
    ...
    linesAnimation = (line, secondLine, text, picture) => {
    ...
    linesAnimationsInTurn = () => {
        const timeouts = [1000, 250, 1500, 3000, 4000]
        for (let i = 0; i < 5; i++) {
            if (i === 0) {
...
// swiper
// set number of slides on resize
...
// add a scroll if needed

addScrollbar()

// lines: start animation on scroll
